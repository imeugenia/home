                            ...
                            <div className="inner-title" style={{maxWidth: "68rem"}} >
                                ...
                                <div style={{marginTop: "8rem"}}>
                                    <a target="_blank" href={myContacts.linkedin}>
                                        <span className="like-h4" style={{color: "#ff6f56", marginRight: "2rem"}}>Linkedin</span>
                                    </a>
                                    <a target="_blank" href={myContacts.twitter}>
                                        <span className="like-h4" style={{color: "#ff6f56", marginRight: "2rem"}}>Twitter</span>
                                    </a>
                                    <a href={`mailto:${myContacts.email}`}>
                                        <span className="like-h4" style={{color: "#ff6f56", marginRight: "2rem"}}>Email</span>
                                    </a>
                                </div>
