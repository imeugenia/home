...
class Longboard extends Component {
    render() {
        return (
            <div className="col-1" id="longboard" style={{order: 11, border: '2px solid #00155c', background: `url(${bg}) no-repeat`,  height: "32rem", backgroundSize: 'auto 100%', textAlign: 'center'}}>
